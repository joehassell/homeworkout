(function () {
  ...
  const YOGA_DB = [
    // ── Standing ─────────────────────────────────
    {name:"Warrior I",image:"yoga-warrior-i.webp",sanskrit:"Virabhadrasana I",cat:"yoga-standing",muscles:["quads","glutes","shoulders","hip flexors"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Warrior II",image:"yoga-warrior-ii.webp",sanskrit:"Virabhadrasana II",cat:"yoga-standing",muscles:["quads","glutes","shoulders"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["vinyasa","hatha","power"],single_sided:true,
    ...
    {name:"Warrior III",image:"yoga-warrior-iii.webp",sanskrit:"Virabhadrasana III",cat:"yoga-balance",muscles:["glutes","hamstrings","core","shoulders"],diff:2,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["vinyasa","hatha","power"],single_sided:true,
    ...
    {name:"Triangle",image:"yoga-triangle.webp",sanskrit:"Trikonasana",cat:"yoga-standing",muscles:["hamstrings","obliques","shoulders"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["vinyasa","hatha","power"],single_sided:true,
    ...
    {name:"Extended Side Angle",image:"yoga-extended-side-angle.webp",sanskrit:"Utthita Parsvakonasana",cat:"yoga-standing",muscles:["quads","obliques","shoulders"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["vinyasa","hatha","power"],single_sided:true,
    ...
    {name:"Chair Pose",image:"yoga-chair-pose.webp",sanskrit:"Utkatasana",cat:"yoga-standing",muscles:["quads","glutes","shoulders"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Crescent Lunge",image:"yoga-crescent-lunge.webp",sanskrit:"Anjaneyasana",cat:"yoga-standing",muscles:["quads","hip flexors","glutes"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:["knees"],
     styles:["vinyasa","hatha","power"],single_sided:true,
    ...
    {name:"Pyramid Pose",image:"yoga-pyramid-pose.webp",sanskrit:"Parsvottanasana",cat:"yoga-standing",muscles:["hamstrings","back"],diff:2,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Wide-Legged Forward Fold",image:"yoga-wide-legged-forward-fold.webp",sanskrit:"Prasarita Padottanasana",cat:"yoga-standing",muscles:["hamstrings","back","adductors"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Goddess Pose",image:"yoga-goddess-pose.webp",sanskrit:"Utkata Konasana",cat:"yoga-standing",muscles:["quads","glutes","adductors"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Revolved Triangle",image:"yoga-revolved-triangle.webp",sanskrit:"Parivrtta Trikonasana",cat:"yoga-standing",muscles:["hamstrings","obliques","spine"],diff:2,
     requires_floor:false,pregnancy_safe:"no",contraindicated_for:[],
     styles:["hatha","vinyasa"],single_sided:true,
    ...
    {name:"Half Moon",image:"yoga-half-moon.webp",sanskrit:"Ardha Chandrasana",cat:"yoga-balance",muscles:["glutes","core","hamstrings"],diff:2,
     requires_floor:false,pregnancy_safe:"early_only",contraindicated_for:[],
     styles:["vinyasa","hatha","power"],single_sided:true,
    ...
    // ── Balance ──────────────────────────────────
    {name:"Tree Pose",image:"yoga-tree-pose.webp",sanskrit:"Vrksasana",cat:"yoga-balance",muscles:["glutes","core","ankles"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Eagle Pose",image:"yoga-eagle-pose.webp",sanskrit:"Garudasana",cat:"yoga-balance",muscles:["shoulders","hips","ankles","core"],diff:2,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["vinyasa","hatha","power"],single_sided:true,
    ...
    {name:"Dancer's Pose",image:"yoga-dancers-pose.webp",sanskrit:"Natarajasana",cat:"yoga-balance",muscles:["quads","shoulders","core","hip flexors"],diff:2,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Standing Hand-to-Toe",image:"yoga-standing-hand-to-toe.webp",sanskrit:"Utthita Hasta Padangusthasana",cat:"yoga-balance",muscles:["hamstrings","core","hip flexors"],diff:3,
     requires_floor:false,pregnancy_safe:"early_only",contraindicated_for:[],
    ...
    {name:"Crow Pose",image:"yoga-crow-pose.webp",sanskrit:"Bakasana",cat:"yoga-balance",muscles:["core","shoulders","wrists"],diff:3,
     requires_floor:true,pregnancy_safe:"no",contraindicated_for:["wrists"],
     styles:["vinyasa","power"],single_sided:false,
    ...
    // ── Floor ────────────────────────────────────
    {name:"Child's Pose",image:"yoga-childs-pose.webp",sanskrit:"Balasana",cat:"yoga-floor",muscles:["back","hips","shoulders"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Cobra",image:"yoga-cobra.webp",sanskrit:"Bhujangasana",cat:"yoga-floor",muscles:["back","chest","shoulders"],diff:1,
     requires_floor:true,pregnancy_safe:"no",contraindicated_for:["lower_back"],
     styles:["vinyasa","hatha","power"],single_sided:false,
    ...
    {name:"Upward-Facing Dog",image:"yoga-upward-facing-dog.webp",sanskrit:"Urdhva Mukha Svanasana",cat:"yoga-floor",muscles:["back","chest","shoulders","wrists"],diff:2,
     requires_floor:true,pregnancy_safe:"no",contraindicated_for:["lower_back"],
     styles:["vinyasa","power"],single_sided:false,
    ...
    {name:"Pigeon Pose",image:"yoga-pigeon-pose.webp",sanskrit:"Eka Pada Rajakapotasana",cat:"yoga-floor",muscles:["glutes","hip flexors","hips"],diff:2,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Bridge Pose",image:"yoga-bridge-pose.webp",sanskrit:"Setu Bandhasana",cat:"yoga-floor",muscles:["glutes","back","hamstrings"],diff:1,
     requires_floor:true,pregnancy_safe:"early_only",contraindicated_for:[],
    ...
    {name:"Sphinx Pose",image:"yoga-sphinx-pose.webp",sanskrit:"Salamba Bhujangasana",cat:"yoga-floor",muscles:["back","chest"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Supine Twist",image:"yoga-supine-twist.webp",sanskrit:"Supta Matsyendrasana",cat:"yoga-floor",muscles:["spine","obliques","chest"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Happy Baby",image:"yoga-happy-baby.webp",sanskrit:"Ananda Balasana",cat:"yoga-floor",muscles:["hips","back","adductors"],diff:1,
     requires_floor:true,pregnancy_safe:"early_only",contraindicated_for:[],
     styles:["hatha","yin","restorative"],single_sided:false,
    ...
    {name:"Locust Pose",image:"yoga-locust-pose.webp",sanskrit:"Salabhasana",cat:"yoga-floor",muscles:["back","glutes","hamstrings"],diff:2,
     requires_floor:true,pregnancy_safe:"no",contraindicated_for:["lower_back"],
    ...
    {name:"Bow Pose",image:"yoga-bow-pose.webp",sanskrit:"Dhanurasana",cat:"yoga-floor",muscles:["back","chest","quads","hip flexors"],diff:2,
     requires_floor:true,pregnancy_safe:"no",contraindicated_for:["lower_back"],
     styles:["hatha","power"],single_sided:false,
    ...
    {name:"Legs Up the Wall",image:"yoga-legs-up-the-wall.webp",sanskrit:"Viparita Karani",cat:"yoga-floor",muscles:["hamstrings","back","nervous system"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    // ── Seated ───────────────────────────────────
    {name:"Seated Forward Fold",image:"yoga-seated-forward-fold.webp",sanskrit:"Paschimottanasana",cat:"yoga-seated",muscles:["hamstrings","back"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:["lower_back"],
     styles:["hatha","yin","restorative"],single_sided:false,
    ...
    {name:"Butterfly Pose",image:"yoga-butterfly-pose.webp",sanskrit:"Baddha Konasana",cat:"yoga-seated",muscles:["hips","adductors","back"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["hatha","yin","restorative"],single_sided:false,
    ...
    {name:"Seated Twist",image:"yoga-seated-twist.webp",sanskrit:"Ardha Matsyendrasana",cat:"yoga-seated",muscles:["spine","obliques","shoulders"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:[],
    ...
    {name:"Head-to-Knee Pose",image:"yoga-head-to-knee-pose.webp",sanskrit:"Janu Sirsasana",cat:"yoga-seated",muscles:["hamstrings","back","hips"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["hatha","yin"],single_sided:true,
    ...
    {name:"Fire Log Pose",image:"yoga-fire-log-pose.webp",sanskrit:"Agnistambhasana",cat:"yoga-seated",muscles:["hips","glutes"],diff:2,
     requires_floor:true,pregnancy_safe:"early_only",contraindicated_for:[],
     styles:["hatha","yin"],single_sided:true,
    ...
    {name:"Hero Pose",image:"yoga-hero-pose.webp",sanskrit:"Virasana",cat:"yoga-seated",muscles:["quads","knees","ankles"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:["knees"],
     styles:["hatha","yin","restorative"],single_sided:false,
    ...
    // ── Inversions ───────────────────────────────
    {name:"Downward-Facing Dog",image:"yoga-downward-facing-dog.webp",sanskrit:"Adho Mukha Svanasana",cat:"yoga-inversion",muscles:["shoulders","hamstrings","calves","back"],diff:1,
     requires_floor:true,pregnancy_safe:"early_only",contraindicated_for:["wrists","shoulders"],
     styles:["vinyasa","hatha","power"],single_sided:false,
    ...
    {name:"Dolphin Pose",image:"yoga-dolphin-pose.webp",sanskrit:"Ardha Pincha Mayurasana",cat:"yoga-inversion",muscles:["shoulders","core","hamstrings"],diff:2,
     requires_floor:true,pregnancy_safe:"early_only",contraindicated_for:["shoulders"],
     styles:["hatha","power"],single_sided:false,
    ...
    {name:"Shoulder Stand",image:"yoga-shoulder-stand.webp",sanskrit:"Sarvangasana",cat:"yoga-inversion",muscles:["core","shoulders","neck"],diff:3,
     requires_floor:true,pregnancy_safe:"no",contraindicated_for:["shoulders"],
    ...
    {name:"Plow Pose",image:"yoga-plow-pose.webp",sanskrit:"Halasana",cat:"yoga-inversion",muscles:["back","shoulders","hamstrings"],diff:2,
     requires_floor:true,pregnancy_safe:"no",contraindicated_for:["shoulders"],
    ...
    // ── Transitions / Flow ───────────────────────
    {name:"Mountain Pose",image:"yoga-mountain-pose.webp",sanskrit:"Tadasana",cat:"yoga-transition",muscles:["full body"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["vinyasa","hatha","power"],single_sided:false,
    ...
    {name:"Standing Forward Fold",image:"yoga-standing-forward-fold.webp",sanskrit:"Uttanasana",cat:"yoga-transition",muscles:["hamstrings","back"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["vinyasa","hatha","power"],single_sided:false,
    ...
    {name:"Halfway Lift",image:"yoga-halfway-lift.webp",sanskrit:"Ardha Uttanasana",cat:"yoga-transition",muscles:["back","hamstrings"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["vinyasa","power"],single_sided:false,
    ...
    {name:"Chaturanga",image:"yoga-chaturanga.webp",sanskrit:"Chaturanga Dandasana",cat:"yoga-transition",muscles:["chest","triceps","core"],diff:2,
     requires_floor:true,pregnancy_safe:"no",contraindicated_for:["wrists","shoulders"],
     styles:["vinyasa","power"],single_sided:false,
    ...
    {name:"Low Lunge",image:"yoga-low-lunge.webp",sanskrit:"Anjaneyasana",cat:"yoga-transition",muscles:["hip flexors","quads"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:["knees"],
     styles:["vinyasa","hatha"],single_sided:true,
    ...
    {name:"Ragdoll",image:"yoga-ragdoll.webp",sanskrit:"",cat:"yoga-transition",muscles:["hamstrings","back","neck"],diff:1,
     requires_floor:false,pregnancy_safe:"yes",contraindicated_for:[],
     styles:["vinyasa","hatha","restorative"],single_sided:false,
    ...
    // ── Core ─────────────────────────────────────
    {name:"Boat Pose",image:"yoga-boat-pose.webp",sanskrit:"Navasana",cat:"yoga-core",muscles:["core","hip flexors"],diff:2,
     requires_floor:true,pregnancy_safe:"no",contraindicated_for:[],
     styles:["vinyasa","hatha","power"],single_sided:false,
    ...
    {name:"Plank Pose",image:"yoga-plank-pose.webp",sanskrit:"Phalakasana",cat:"yoga-core",muscles:["core","shoulders","arms"],diff:1,
     requires_floor:true,pregnancy_safe:"early_only",contraindicated_for:["wrists"],
     styles:["vinyasa","hatha","power"],single_sided:false,
    ...
    {name:"Savasana",image:"yoga-savasana.webp",sanskrit:"Savasana",cat:"yoga-savasana",muscles:["full body"],diff:1,
     requires_floor:true,pregnancy_safe:"yes",contraindicated_for:[],
  ...
  function generateYogaWorkout(config, focusState, workoutArr, experience, yogaEquip) {
    ...
    // ── Capability safety filter ─────────────────────
    const capability = (typeof window !== 'undefined' && window.capability) || {};
    const profile = (typeof window !== 'undefined' && window.userProfile) ||
                    (capability.DEFAULT_PROFILE || {});
    const caps = capability.deriveCaps ? capability.deriveCaps(profile) : null;

    function posePassesSafety(p) {
      return !caps || !capability.isAllowed || capability.isAllowed(p, caps, profile, {});
    }

    workoutArr.length = 0; // clear

    // 1. Centering (defensive safety check)
    if (posePassesSafety(CENTERING)) {
      workoutArr.push({
        exercise: CENTERING,
      ...
      if (phase === 'sun-sal') {
        ...
        for (let r = 0; r < rounds && remaining > 60; r++) {
          ...
          for (const poseName of salSeq) {
            ...
            if (!pose) continue;
            if (!posePassesSafety(pose)) continue; // skip blocked poses
    ...
    // 4. Savasana (always last, defensive safety check)
    const savasana = YOGA_DB.find(p => p.name === 'Savasana');
    if (savasana && posePassesSafety(savasana)) {
      workoutArr.push({
        exercise: savasana,
